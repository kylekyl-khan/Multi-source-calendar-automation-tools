...
function init_address() {
    ...
    var zone1 = document.getElementById('DropDownList7');
    var zone2 = document.getElementById('DropDownList8');
    var zone3 = document.getElementById('DropDownList9');
    var zone4 = document.getElementById('DropDownList10');
    var zone5 = document.getElementById('DropDownList11');
    var zone6 = document.getElementById('DropDownList12');

    zone1.options.add(first());
    zone2.options.add(first());
    zone3.options.add(first());
    zone4.options.add(first());
    zone5.options.add(first());
    zone6.options.add(first());
    ...
    zone1.onchange = function () {
        ...
        document.getElementById('DropDownList8').value = "";
    ...
    zone3.onchange = function () {
        document.getElementById('TextBox48').value = "";
        document.getElementById('DropDownList10').value = "";
    ...
    zone5.onchange = function () {
        document.getElementById('TextBox49').value = "";
        document.getElementById('DropDownList12').value = "";
    ...
    zone2.onchange = function () {
        if (this.selectedIndex > 0)
            document.getElementById('TextBox47').value = zip[zone1.value][zone2.value];
    };
    zone4.onchange = function () {
        if (this.selectedIndex > 0)
            document.getElementById('TextBox48').value = zip[zone3.value][zone4.value];
    };
    zone6.onchange = function () {
        if (this.selectedIndex > 0)
            document.getElementById('TextBox49').value = zip[zone5.value][zone6.value];
    };
}
