<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Label ID="Label31" runat="server" Font-Size="X-Large" ForeColor="#660033" 
        Text='<%$Resources:Resource,TotalForms2 %>'></asp:Label>
    <br />
    <asp:Label ID="Label37" runat="server" Font-Size="Medium" ForeColor="#660033" 
    ...
    <asp:Label ID="Label36" runat="server" Font-Size="Medium" ForeColor="#660033" 
        Text='<%$ Resources:Resource,SearchByCampus %>'></asp:Label>
    <asp:DropDownList ID="DropDownList3" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged">
        <asp:ListItem>所有校區</asp:ListItem>
        <asp:ListItem>秀岡</asp:ListItem>
        <asp:ListItem>青山</asp:ListItem>
    ...
    <asp:Label ID="Label32" runat="server" Font-Size="Medium" ForeColor="#660033" 
        Text='<%$Resources:Resource,SearchByNoOrApplicant %>'></asp:Label>
    <asp:TextBox ID="TextBox1" runat="server" AutoPostBack="True" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
&nbsp;<br />
    <asp:Label ID="Label33" runat="server" Font-Size="Medium" ForeColor="#660033" 
        Text='<%$Resources:Resource,SearchByDate %>'></asp:Label>
    <asp:TextBox ID="TextBox3" runat="server" Font-Size="Medium" AutoPostBack="True" OnTextChanged="TextBox3_TextChanged"></asp:TextBox>
    ~<asp:TextBox ID="TextBox4" runat="server" Font-Size="Medium" AutoPostBack="True" OnTextChanged="TextBox3_TextChanged"></asp:TextBox>
    <hr />
    <asp:GridView ID="GridView1" runat="server" BackColor="White" 
        BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
        ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="False" 
        DataKeyNames="ListNum" DataSourceID="SqlDataSource1" AllowPaging="True" Width="98%" Font-Size="Small" PageSize="15">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Campus" HeaderText='<%$Resources:Resource,Campus %>'
                SortExpression="Campus" />
            <asp:BoundField DataField="Name" HeaderText='<%$Resources:Resource,Applicant%>' SortExpression="Name" />
            <asp:BoundField DataField="VTypeName" HeaderText='<%$Resources:Resource,Type %>'
                SortExpression="VTypeName" />
            <asp:BoundField DataField="startTime" HeaderText='<%$Resources:Resource,intoSchoolBeginTime %>' SortExpression="startTime" DataFormatString="{0:yyyy/MM/dd HH:mm:ss}" />
            <asp:BoundField DataField="endTime" HeaderText='<%$Resources:Resource,intoSchoolEndTime %>' SortExpression="endTime" DataFormatString="{0:yyyy/MM/dd HH:mm:ss}" />
